...
Public Class frmStage2
    ...
    Private tmrEnemyHeal As New Timer()
    ...
    Private healAnimationFrame As Integer = 0
    ...
    Public Sub New()
        ...
        AddHandler tmrEnemyHeal.Tick, AddressOf tmrEnemyHeal_Tick
    End Sub
    ...
    Private Sub frmStage2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        picEnemySprite.Location = New Point(110, 10)
    End Sub
    ...
    Private Sub InitializeUI()
        ...
        idleEnemyBackground = My.Resources.s2
    ...
    Private Sub AskNextQuestion()
        ...
        turnCounter += 1
        If turnCounter > 1 AndAlso (turnCounter - 1) Mod 4 = 0 Then
            StartEnemyHealAnimation()
            Return
        End If
    ...
    Private Sub EnemyTurn()
        If CInt(characterData("CharacterID")) = 5 AndAlso rnd.Next(1, 101) <= 30 Then
            isBlocking = True
            tmrEnemyAnimation.Interval = 200
    ...
    Private Sub tmrEnemyAnimation_Tick(sender As Object, e As EventArgs)
        If Not isBlocking Then
            Select Case enemyAnimationFrame
                Case 1 : Me.BackgroundImage = My.Resources.s2a
                Case 2 : picEnemySprite.Image = My.Resources.s2a1
                Case 3 : picEnemySprite.Image = My.Resources.s2a2
                Case 4 : picEnemySprite.Image = My.Resources.s2a3
                Case 5 : picEnemySprite.Image = My.Resources.s2a4
                Case 6 : picEnemySprite.Image = Nothing
                Case 7
                    Me.BackgroundImage = My.Resources.s2
        ...
        Else
            Select Case enemyAnimationFrame
                Case 0 : Me.BackgroundImage = My.Resources.s2a
                Case 1
                    Me.BackgroundImage = My.Resources.s2a
    ...
    Private Sub ApplyDamageAndTriggerEnemyHit()
        If CInt(characterData("CharacterID")) = 6 Then
            Dim hpStolen As Integer = CInt(damageToApplyToEnemy * 0.5)
    ...
    Private Sub tmrEnemyHit_Tick(sender As Object, e As EventArgs)
        Select Case enemyHitFrame
            Case 1, 4, 7 : Me.BackgroundImage = My.Resources.s2h
            Case 2, 5 : Me.BackgroundImage = My.Resources.s2b
            Case 3, 6 : Me.BackgroundImage = My.Resources.s2
            Case 8 : Me.BackgroundImage = idleEnemyBackground
            Case Else
                tmrEnemyHit.Stop()
    ...
    Private Sub StartEnemyHealAnimation()
        healAnimationFrame = 1
        tmrEnemyHeal.Interval = 200
        tmrEnemyHeal.Start()
    End Sub

    Private Sub tmrEnemyHeal_Tick(sender As Object, e As EventArgs)
        Select Case healAnimationFrame
            Case 1 To 8
                Me.BackgroundImage = My.Resources.s2heal
            Case 9
                Dim healAmount As Integer = 5 + CInt(playerStats("Stat_Intelligence"))
                enemyCurrentHP += healAmount
                If enemyCurrentHP > pbEnemyHP.Maximum Then
                    enemyCurrentHP = pbEnemyHP.Maximum
                End If
                pbEnemyHP.Value = enemyCurrentHP
                lblEnemyHP.Text = $"HP: {enemyCurrentHP} / {pbEnemyHP.Maximum}"
            Case Else
                tmrEnemyHeal.Stop()
                Me.BackgroundImage = idleEnemyBackground
                AskNextQuestion()
        End Select
        healAnimationFrame += 1
    End Sub
